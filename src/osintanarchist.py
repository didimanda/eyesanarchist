...
class osintanarchist:
    ...
    def get_addrs(self):
        ...
        pc.printout("Looking for target address...\n")
        ...
        if len(sort_addresses) > 0:
            ...
            t.align["Address"] = "l"
            t.align["Time"] = "l"
            pc.printout("\nDear anarchist, we have " + str(len(sort_addresses)) + " addresses\n", pc.GREEN)
    ...
    def get_captions(self):
        ...
        if counter > 0:
            pc.printout("\nDear anarchist, we have  " + str(counter) + " captions\n", pc.GREEN)
